...
export const Offer = () => {
  return (
    <div className='flex items-center justify-center h-screen bg-customNeon'>
      <div className="flex flex-col md:flex-row md:items-center md:justify-center w-full md:w-4/5 lg:w-3/5 px-4 mt-4 mb-4"> {/* Adjusted container size and margin here */}
        <div className="md:w-1/2 order-2 md:order-1 animated fadeInLeft">
        ...
        <div className="md:w-1/2 order-3 md:order-3 animated fadeInRight">
